...
const buildLogs: LogEntry[] = [
  {
    ...
    tech: ["Next.js", "TypeScript", "Tailframed CSS", "Framer Motion", "Vercel"],
    metrics: "100/100 Lighthouse performance score",
  },
  {
    date: "May 2026",
    title: "Overhauled Scam Guard AI Detection",
    category: "Feature",
    description: "Re-engineered the text risk scoring engine to use lightweight local context parsing alongside external AI APIs, allowing real-time phishing and fraud pattern detection with low latency.",
    tech: ["JavaScript", "Browser Extension APIs", "AI Models"],
    metrics: "Reduced API latency by 45%",
  },
  {
    date: "April 2026",
    title: "Architected CogniVault Dual-Engine Pipeline",
    category: "Experiment",
    description: "Designed a token-efficient analytical routing system that delegates deep reasoning to OpenRouter's Gemini model and quick extractions to Groq. Stored structured JSON outputs directly in Supabase.",
    tech: ["React", "Node.js", "Supabase", "OpenRouter", "Groq"],
    metrics: "Reduced LLM token costs by 60%",
  },
  {
    date: "September 2024",
    title: "Led Team at Smart India Hackathon (SIH)",
    category: "Hackathon",
    description: "Led a 6-member team from zero to prototype under 12-hour limits. Shipped Scam Guard, a browser-based risk identifier. Handled architecture, task delegation, and the web extension core.",
    tech: ["JavaScript", "HTML/CSS", "Extension APIs"],
    metrics: "Internal Hackathon winner",
  },
  {
    date: "May 2024",
    ...
    metrics: "0% race conditions on equipment bookings",
  },
]
